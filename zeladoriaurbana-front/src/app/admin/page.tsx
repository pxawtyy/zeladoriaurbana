      ...
      <header className="bg-[#004383] text-white shadow-md sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            <svg className="w-6 h-6 sm:w-7 sm:h-7 text-blue-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center gap-4 sm:gap-4">
            <a href="/" className="text-sm font-medium text-blue-200 hover:text-white transition flex items-center gap-1" title="Voltar ao site">
          ...
          {!isLoading && chamados.length > 0 && (
            <div className="bg-slate-50 border-t border-slate-200 p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
              <span className="text-sm text-slate-500 text-center sm:text-left">
                A mostrar <span className="font-medium text-slate-900">{startIndex + 1}</span> até <span className="font-medium text-slate-900">{Math.min(endIndex, chamados.length)}</span> de <span className="font-medium text-slate-900">{chamados.length}</span> resultados
              </span>
