            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200 text-sm text-slate-600">
                  ...
                  <th className="p-4 font-semibold text-center">Anexo</th>
                  ...
                  chamados.map((chamado) => (
                    <tr key={chamado.protocolo} className="hover:bg-slate-50 transition">
                      ...
                      <td className="p-4 text-center">
                        {chamado.imagemUrl ? (
                          <a 
                            href={chamado.imagemUrl} 
                            target="_blank" 
                            rel="noopener noreferrer"
                            className="inline-flex items-center justify-center text-[#004383] hover:text-[#003B73] hover:bg-blue-50 p-2 rounded-full transition"
                            title="Ver fotografia anexada"
                          >
