        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center flex flex-col items-center justify-center">
          ...
          <div className="mt-10">
            <button
              ...
              className="bg-[#004383] hover:bg-[#003B73] text-white font-medium px-8 py-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex items-center gap-2 text-base cursor-pointer"
            >
