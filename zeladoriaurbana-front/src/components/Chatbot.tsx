      ...
      {isOpen && (
        <div className="mb-4 w-80 sm:w-96 bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col transition-all duration-300 transform origin-bottom-right">
          ...
          <div className="h-96 bg-slate-50 p-4 overflow-y-auto flex flex-col gap-3">
            <div className="bg-white border border-slate-200 text-slate-700 p-3 rounded-2xl rounded-tl-none text-sm max-w-[85%] shadow-sm">
              Olá! Sou o assistente de Zeladoria Urbana. Como posso chamar você?
            </div>
            
            <div className="bg-[#004383] text-white p-3 rounded-2xl rounded-tr-none text-sm max-w-[85%] self-end shadow-sm">
              Oi, meu nome é João.
            </div>
          </div>
          ...
          <div className="p-3 bg-white border-t border-slate-200 flex gap-2">
            ...
            />
            <button className="bg-[#004383] hover:bg-[#003B73] text-white p-2 rounded-full transition flex items-center justify-center">
